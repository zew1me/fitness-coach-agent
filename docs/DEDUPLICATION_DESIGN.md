...
| RPC                                                                                                                                      | Behaviour                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `merge_activity(p_user_id, p_surviving_id, p_merged_id, p_expected_versions, p_merged_fields, p_proposal_id, p_confirmation_message_id)` | For Tier B, locks and verifies an unexpired pending proposal plus its later user message whose normalized text equals `expected_phrase`; the two nullable confirmation args are injected by trusted orchestration, not the model. Then uses plan-first/activity-id lock order, revalidates links and exact member versions across the complete logical group — survivor, still-active members, and members already merged into it — transfers any plan link, applies fields/audit, and consumes the proposal atomically. Stale versions raise `40001`; invalid state raises `22023`. Tier A passes null confirmation args; an exact completed retry returns current state |
